...
export class LicenseController {
  ...
  @ApiOperation({ summary: 'Health check do serviço de licenças', description: 'Verifica o status do serviço externo de geração de carteirinhas. Exclusivo para ADMIN.' })
  ...
  @Get('/all')
  @ApiOperation({ summary: 'List all licenses', description: 'Returns all registered licenses.' })
  ...
  @ApiOperation({ summary: 'Find license by student ID', description: 'Returns the license associated with a specific student.' })
  ...
  @Get('/:id')
  @ApiOperation({ summary: 'Find license by ID', description: 'Returns the data of a specific license.' })
  @ApiParam({ name: 'id', description: 'License ID (MongoDB ObjectId)', example: '6650a1f2c3d4e5f6a7b8c9d0' })
  ...
  @Patch('/update/:id')
  @ApiOperation({ summary: 'Update license', description: 'Updates the data of an existing license.' })
  @ApiParam({ name: 'id', description: 'License ID (MongoDB ObjectId)', example: '6650a1f2c3d4e5f6a7b8c9d0' })
  @ApiBody({ type: CreateLicenseDto })
  ...
  @Delete('/delete/:id')
  @ApiOperation({ summary: 'Remove license', description: 'Removes a license permanently.' })
  @ApiParam({ name: 'id', description: 'License ID (MongoDB ObjectId)', example: '6650a1f2c3d4e5f6a7b8c9d0' })
